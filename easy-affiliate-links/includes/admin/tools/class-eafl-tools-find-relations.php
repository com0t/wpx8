...
class EAFL_Tools_Find_Relations {
	...
	public static function add_submenu_page() {
		add_submenu_page( null, __( 'Link Usage', 'easy-affiliate-links' ), __( 'Link Usage', 'easy-affiliate-links' ), EAFL_Settings::get( 'tools_capability' ), 'eafl_find_relations', array( __CLASS__, 'page_content' ) );
	}
