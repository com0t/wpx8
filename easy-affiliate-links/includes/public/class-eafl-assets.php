...
class EAFL_Assets {
	...
	public static function enqueue_admin() {
		...
		$eafl_admin = array(
			...
			'nonce' => wp_create_nonce( 'eafl' ),
			'endpoints' => array(
				'link' => get_rest_url( null, 'wp/v2/' . EAFL_POST_TYPE ),
				'category' => get_rest_url( null, 'wp/v2/eafl_category' ),
				'manage' => get_rest_url( null, 'easy-affiliate-links/v1/manage' ),
				'click' => get_rest_url( null, 'easy-affiliate-links/v1/click' ),
				'notices' => get_rest_url( null, 'easy-affiliate-links/v1/notice' ),
				'search' => get_rest_url( null, 'easy-affiliate-links/v1/search' ),
			),
			'addons' => array(
